...
public class BossAbilityPelletBurst : BossAbility
{
    ...
    public override void UseAbility()
    {
        ...
        projectile1.GetComponent<BossAbilityPelletBurstMovement>().velocity = (new Vector2(10f,0f));
        projectile2.GetComponent<BossAbilityPelletBurstMovement>().velocity = (new Vector2(-10f, 0f));
        projectile3.GetComponent<BossAbilityPelletBurstMovement>().velocity = (new Vector2(0f, 10f));
        projectile4.GetComponent<BossAbilityPelletBurstMovement>().velocity = (new Vector2(0f, -10f));
        projectile5.GetComponent<BossAbilityPelletBurstMovement>().velocity = (new Vector2(7.071f, 7.071f));
        projectile6.GetComponent<BossAbilityPelletBurstMovement>().velocity = (new Vector2(-7.071f, 7.071f));
        projectile7.GetComponent<BossAbilityPelletBurstMovement>().velocity = (new Vector2(7.071f, -7.071f));
        projectile8.GetComponent<BossAbilityPelletBurstMovement>().velocity = (new Vector2(-7.071f, -7.071f));
