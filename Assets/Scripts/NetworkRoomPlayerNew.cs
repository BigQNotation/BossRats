...
/// </summary>
public class NetworkRoomPlayerNew : NetworkRoomPlayer
{
    ...
    void DrawPlayerReadyState()
    {
        ...
        if (((isServer && index > 0) || isServerOnly) && GUILayout.Button("REMOVE"))
        {
            ...
            TargetValidGameOverStatus(GetComponent<NetworkIdentity>().connectionToClient);
    ...
    [TargetRpc]
    void TargetValidGameOverStatus(NetworkConnection target)
    {
